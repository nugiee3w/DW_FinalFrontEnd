    ...
    <div class="flex flex-col gap-9">
        <div class="flex flex-col items-center gap-1">
            ...
            <div class="flex items-center gap-2">
                <a href="#" class="font-medium text-aktiv-grey last:font-semibold last:text-aktiv-black">Homepage</a>
                <span>></span>
                <a href="#" class="font-medium text-aktiv-grey last:font-semibold last:text-aktiv-black">Category Workshop</a>
            </div>
        </div>
                        ...
                        <div class="flex flex-col gap-[18px]">
                            ...
                            <div class="card-detail flex flex-col gap-2">
                                ...
                                <h3 class="title min-h-[56px] font-semibold text-xl line-clamp-2 hover:line-clamp-none">
                                    Mastering the Art of Public Speaking: Practical Tips and Powerful Techniques
                                </h3>
